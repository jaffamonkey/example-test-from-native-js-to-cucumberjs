...
exports.default = (url, sessionId, elementId, { JsonWire }) => (
/**
 ...
 */
{
   ...
   * })();
   */
  sendKeys: text => (0, _rest.POST)(`${url}/session/${sessionId}/element/${elementId}/value`, !JsonWire ? { text } : { value: [text] }),
   ...
   * })();
   */
  click: () => (0, _rest.POST)(`${url}/session/${sessionId}/element/${elementId}/click`, {}),
   ...
   * })();
   */
  getText: () => (0, _rest.GET)(`${url}/session/${sessionId}/element/${elementId}/text`).then(({ value }) => value),
   ...
   * })();
   */
  getCss: propertyName => (0, _rest.GET)(`${url}/session/${sessionId}/element/${elementId}/css/${propertyName}`).then(({ value }) => value)
});