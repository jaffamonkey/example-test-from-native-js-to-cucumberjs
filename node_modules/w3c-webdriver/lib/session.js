 ...
 */
{
   ...
   * })();
   */
  getTitle: () => (0, _rest.GET)(`${url}/session/${sessionId}/title`).then(({ value }) => value),
  ...
  findElement: (strategy, selector) => (0, _rest.POST)(`${url}/session/${sessionId}/element`, {
    using: strategy,
    value: selector
  }).then(({ value: element }) => (0, _element2.default)(url, sessionId,
  // JSON Wire    || Web Driver
  element.ELEMENT || Object.values(element)[0], { JsonWire })),
   ...
   * })();
   */
  findElements: (strategy, selector) => (0, _rest.POST)(`${url}/session/${sessionId}/elements`, {
    using: strategy,
    value: selector
  }).then(({ value: elements }) => {
    //                                         JSON Wire       || Web Driver
    ...
    return elementIds.map(elementId => (0, _element2.default)(url, sessionId, elementId, { JsonWire }));
  }),
   ...
   * })();
   */
  getTimeout: () => (0, _rest.GET)(`${url}/session/${sessionId}/timeouts`).then(({ value }) => value),
   ...
   * })();
   */
  getPageSource: () => (0, _rest.GET)(`${url}/session/${sessionId}/source`).then(({ value }) => value),
   ...
   * })();
   */
  executeScript: (script, args = []) => (0, _rest.POST)(`${url}/session/${sessionId}/execute${!JsonWire ? '/sync' : ''}`, {
    script,
    args
  }).then(({ value }) => value),
   ...
   * })();
   */
  executeAsyncScript: (script, args = []) => (0, _rest.POST)(`${url}/session/${sessionId}/execute${!JsonWire ? '/async' : '_async'}`, {
    script,
    args
  }).then(({ value }) => value),
   ...
   * })();
   */
  getAllCookies: () => (0, _rest.GET)(`${url}/session/${sessionId}/cookie`).then(({ value }) => value),
   ...
   * })();
   */
  addCookie: cookie => (0, _rest.POST)(`${url}/session/${sessionId}/cookie`, { cookie }),
   ...
   * })();
   */
  takeScreenshot: () => (0, _rest.GET)(`${url}/session/${sessionId}/screenshot`).then(({ value }) => Buffer.from(value, 'base64'))
});